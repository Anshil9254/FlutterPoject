...
class SellMilkPriceChangePage extends StatefulWidget {
  const SellMilkPriceChangePage({super.key});

  @override
  State<SellMilkPriceChangePage> createState() => _SellMilkPriceChangePageState();
}

class _SellMilkPriceChangePageState extends State<SellMilkPriceChangePage> {
  ...
  Future<void> _loadPrices() async {
    ...
    try {
      ...
      if (cowQuery.docs.isNotEmpty) {
        ...
        _cowPriceController.text = cowPrice.pricePerLiter.toString();
      } else {
        _cowPriceController.text = '50.0'; // Default value
      }
      ...
      if (buffaloQuery.docs.isNotEmpty) {
        ...
        _buffaloPriceController.text = buffaloPrice.pricePerLiter.toString();
      } else {
        _buffaloPriceController.text = '60.0'; // Default value
      }
    } catch (e) {
  ...
  Future<void> _savePrices() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Milk prices updated successfully!'),
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ReusableHeader(
                    title: 'Sell Milk Price Management',
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'The price set here will be used to calculate milk sales based on quantity in liters. These prices are used in the "Sell Milk" section for instant calculations.',
                          style: TextStyle(
                            fontSize: 12,
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  labelText: 'Enter price per liter',
