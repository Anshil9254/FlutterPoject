  ...
  Future<void> _processWalletPayment() async {
    ...
    try {
      ...
      if (opened) {
        ...
        // Wait for user to complete payment in external app
        ...
        await InvoiceService.createPayment(
          ...
          paymentMethod: _walletDisplayNames[_selectedWallet!] ?? 'Wallet',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _selectedWallet != null && !_isProcessing
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 10),
                const Text(
                  "Please complete the payment in the external app...",
  ...
  void _showPaymentError(BuildContext context, String error) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text("There was an error processing your payment: $error"),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text("OK"),
